...
app.get('/', (req, res) => {
    res.render('meetingpage', { roomId: '132492045d729384579342', user: 'Rampravesh' })
})
...
server.listen(process.env.PORT || 3030, () => console.log('Server running on http://localhost:8000/'));
io.ioserver(server);